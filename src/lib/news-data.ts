...
export const newsArticles: NewsArticle[] = [
  ...
  {
    slug: "over-500000-mt-handled",
    title: "Over 500,000 metric tons of cargo handled",
    excerpt:
      "VOTPI Maritime has handled more than 500,000 metric tons of cargo across its marine operations.",
    body: [
      "VOTPI Maritime has handled more than 500,000 metric tons of cargo across its marine operations. This milestone reflects the volume of work completed moving cargo by sea.",
      "The company recognises the customers and operational teams involved in coordinating these cargo movements.",
    ],
    publishedAt: "2026-09-24",
    publishedDisplay: "September 2026",
    image: "/images/hero-news.jpg",
